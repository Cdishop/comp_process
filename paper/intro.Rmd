...
Which of these is a process study? Where is the line between explaining the process versus describing its emergent properties? In this paper, we try to build consensus around these issues. What do we mean by process? And what are the different ways that we can represent it? We approach these questions in two parts.
...
Process is distinct from each of these terms, and it does not need to be paired with any. Processes can grow, or they can not grow; they can contain change or no change; they can contain dynamics or no dynamics. Stated differently, just because something does not change or grow does not mean there is no process to be found. But this does not mean that every longitudinal study captures process in the same way. To differentiate here, we need an additional category: explanation versus description. 
