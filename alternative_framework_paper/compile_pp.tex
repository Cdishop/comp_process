...
\hypersetup{unicode=true,
            ...
            pdfkeywords={dynamic, dynamics, linear dynamic systems model, dynamic systems, longitudinal, process},
            pdfborder={0 0 0},
            breaklinks=true}
...
Dishop, C. R., Olenick, J., \& DeShon, R. P. (In press). Principles For Taking a Dynamic Perspective. In Griep, Y., Hansen, S. D., Vantilborgh, T., \& Hofmans, J. (Ed.), Handbook of Temporal Dynamic Organizational Behavior. Edward Elgar Publishing.

Correspondence concerning this article should be addressed to Christopher R. Dishop, 316 Physics Rd, Psychology Building Room 348, East Lansing, MI 48823. E-mail: \href{mailto:dishopch@msu.edu}{\nolinkurl{dishopch@msu.edu}}}
