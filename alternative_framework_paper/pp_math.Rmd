...
\noindent This representation is also an error process, but there is performance self-similarity across time. The upper panel of figure \ref{noise} presents a random walk. Although random walks can sometimes appear to be moving in a systematic direction, ultimately their behavior is unpreditable: they could go up or down at any moment. 
