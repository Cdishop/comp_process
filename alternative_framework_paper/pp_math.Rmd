...
\noindent Here, all we have is error over time. The lower panel of figure \ref{noise} shows the behavior of a white noise process over time. Random walks are similar, but $a$ is now equal to one.
